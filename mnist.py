...
trn_X = trn_X.reshape(trn_num_sample, -1) # shape: 从 (1000，28, 28) 变成 (1000，784)
std_X, mean_X = np.std(trn_X, axis=0, keepdims=True)+1e-4, np.mean(trn_X, axis=0, keepdims=True) # 标准差 std_X
